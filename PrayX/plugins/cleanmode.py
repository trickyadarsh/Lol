...
from PrayX import app, userbot
from PrayX.misc import SUDOERS
from PrayX.utils.database import (get_active_chats,
                                       ...
                                       update_user_top)
from PrayX.utils.decorators.language import language
from PrayX.utils.formatters import alpha_to_int
...
async def braodcast_message(client, message, _):
    ...
    if "-assistant" in message.text:
        ...
        text = _["broad_3"]
        from PrayX.core.userbot import assistants
